...
(function(vue, shared) {
  ...
  const config = {
    baseUrl: "http://1m85s39099.imwork.net:50641"
  };
  ...
  const _sfc_main$d = {
    ...
    methods: {
      async alipay() {
        ...
        formatAppLog("log", "at pages/order-plus/order-plus.vue:79", res);
        const orderInfo = res.data.orderInfo;
        uni.getProvider({
          service: "payment",
          success: function(res2) {
            formatAppLog("log", "at pages/order-plus/order-plus.vue:85", res2.provider);
            if (~res2.provider.indexOf("alipay")) {
              uni.requestPayment({
                "provider": "alipay",
                //固定值为"alipay"
                "orderInfo": orderInfo,
                ...
                success: function(res3) {
                  formatAppLog("log", "at pages/order-plus/order-plus.vue:91", res3);
                  JSON.parse(res3.rawdata);
                  formatAppLog("log", "at pages/order-plus/order-plus.vue:93", "支付成功");
                },
                fail: function(err) {
                  formatAppLog("log", "at pages/order-plus/order-plus.vue:96", "支付失败:" + JSON.stringify(err));
                }
              });
            }
          }
      ...
      async alipayQuery() {
        ...
        formatAppLog("log", "at pages/order-plus/order-plus.vue:109", res);
        uni.showModal({
          title: "查询结果",
      ...
      async alipayRefund() {
        ...
        formatAppLog("log", "at pages/order-plus/order-plus.vue:121", res);
        uni.showModal({
          title: "退款结果",
          content: JSON.stringify(res.data)
        });
      ...
      async alipayWapPay() {
        ...
        formatAppLog("log", "at pages/order-plus/order-plus.vue:134", res.data.result);
        let url = "https://openapi-sandbox.dl.alipaydev.com/gateway.do?" + res.data.result;
        url = escape(url);
        formatAppLog("log", "at pages/order-plus/order-plus.vue:138", url);
        uni.navigateTo({
  ...
  function _sfc_render$c(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_tw_nav_bar = vue.resolveComponent("tw-nav-bar");
    const _component_tag = vue.resolveComponent("tag");
    const _component_card_tapable = vue.resolveComponent("card-tapable");
    const _component_card = vue.resolveComponent("card");
    return vue.openBlock(), vue.createElementBlock(
      "view",
      {
        class: "absolute top-0 w-full",
        style: vue.normalizeStyle($data.containerStyle)
      },
      [
        vue.createVNode(_component_tw_nav_bar),
        vue.createElementVNode(
          "scroll-view",
          {
            "scroll-y": true,
            class: "absolute",
            style: vue.normalizeStyle($data.scrollViewStyle)
          },
          [
            vue.createElementVNode("view", { class: "px-3 space-y-1.5" }, [
              vue.createVNode(_component_card, null, {
                default: vue.withCtx(() => [
                  vue.createElementVNode("view", { class: "space-y-1" }, [
                    vue.createVNode(_component_card_tapable, null, {
                      default: vue.withCtx(() => [
                        vue.createElementVNode("text", { class: "text-lg font-bold break-all line-clamp-2" }, [
                          vue.createVNode(_component_tag, { class: "relative top-[-3px] mr-1" }, {
                            default: vue.withCtx(() => [
                          ...
                          vue.createElementVNode("text", { class: "tracking-wider" }, "重庆总部城A区-4号楼 重庆市渝中区虎踞路62号12-1")
                        ])
                      ]),
                      _: 1
                      /* STABLE */
                    }),
                    vue.createElementVNode("view", { class: "text-sm text-gray-400" }, "陆宪甫 先生  17783683002"),
                    vue.createElementVNode("view", { class: "text-xs text-green-600" }, "点餐请适量，环保又健康")
                  ]),
                  vue.createElementVNode("view", { class: "pt-5 space-y-1" }, [
                    vue.createVNode(_component_card_tapable, { class: "text-sm" }, {
                      default: vue.withCtx(() => [
                        vue.createElementVNode("view", { class: "flex w-full" }, [
                          vue.createElementVNode("view", { class: "font-bold" }, "立即送出"),
                          vue.createElementVNode("view", { class: "ml-auto text-orange-500" }, "15:46-16:01送达")
                        ])
                      ]),
                      _: 1
                      /* STABLE */
                    }),
                    vue.createElementVNode("view", { class: "text-xs text-orange-500" }, "由商家自行配送，实际送达时间可联系商家确认")
                  ])
                ]),
                _: 1
                /* STABLE */
              ...
              vue.createVNode(_component_card, null, {
                default: vue.withCtx(() => [
                  vue.createVNode(_component_card_tapable, null, {
                    default: vue.withCtx(() => [
                      vue.createElementVNode("view", { class: "h-full flex items-center text-sm" }, [
                        vue.createElementVNode("view", { class: "font-bold" }, "支付方式"),
                        vue.createElementVNode("view", { class: "ml-auto flex items-center" }, [
                          vue.createElementVNode("view", { class: "text-xs" }, [
                            vue.createTextVNode("送满20减 "),
                            vue.createElementVNode("text", { class: "text-orange-500" }, "5元"),
                            vue.createTextVNode(" 外卖券 ")
                          ]),
                          vue.createElementVNode("view", { class: "ml-2" }, "急速支付")
                        ])
                      ])
                    ]),
                    _: 1
                ...
                default: vue.withCtx(() => [
                  vue.createElementVNode("view", { class: "space-y-1" }, [
                    vue.createElementVNode("button", {
                      class: "btn",
                      onClick: _cache[0] || (_cache[0] = (...args) => $options.alipay && $options.alipay(...args))
                    }, "支付宝支付"),
                    vue.withDirectives(vue.createElementVNode(
                      "input",
                      {
                        class: "py-3 h-[64px]",
                        "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => $data.alipayOrderNo = $event),
                        type: "text",
                      ...
                      [vue.vModelText, $data.alipayOrderNo]
                    ]),
                    vue.createElementVNode("button", {
                      class: "btn",
                      onClick: _cache[2] || (_cache[2] = (...args) => $options.alipayQuery && $options.alipayQuery(...args))
                    }, "支付宝查询订单"),
                    vue.createElementVNode("button", {
                      class: "btn",
                      onClick: _cache[3] || (_cache[3] = (...args) => $options.alipayRefund && $options.alipayRefund(...args))
                    }, "支付宝卖家退款"),
                    vue.createElementVNode("button", {
                      class: "btn",
                      onClick: _cache[4] || (_cache[4] = (...args) => $options.alipayWapPay && $options.alipayWapPay(...args))
                    }, "支付宝手机网页支付")
                  ])
                ]),
                _: 1
  ...
  const PagesOrderPlusOrderPlus = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["render", _sfc_render$c], ["__file", "D:/projects/学校/外卖app/client/pages/order-plus/order-plus.vue"]]);
  const _sfc_main$c = {
    data() {
      return {};
    },
  ...
  function _sfc_render$b(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "order-wrapper" }, [
      vue.createCommentVNode(' <nav-bar-plus bgColor="transparent" title="提交订单" :back="()=>{}"></nav-bar-plus>\r\n		<view class="order-container">\r\n			<uni-card class="card info">\r\n				<view class="info-container">\r\n					<view class="title">重庆总部城A区-4号楼 重庆市渝中区虎踞路62号12-1</view>\r\n					<view class="detail uni-info">王得发&nbsp;先生&nbsp;&nbsp;&nbsp;&nbsp;15877845159</view>\r\n					<view class="tip uni-success">点餐请适量，环保又健康</view>\r\n					<view class="space-between send-out">\r\n						<view>立即送出</view>\r\n						<view class="time">10:44-10:59送达></view>\r\n					</view>\r\n				</view>\r\n			</uni-card>\r\n			<uni-card class="card">\r\n				<view class="space-between">\r\n					<view>支付方式</view>\r\n					<view class="yh-right">\r\n						<view class="yh">送满20减<text class="number">5元</text>外卖卷</view>\r\n						<view>急速支付></view>\r\n					</view>\r\n				</view>\r\n			</uni-card>\r\n		</view> ')
    ]);
  }
  const PagesOrderOrder = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["render", _sfc_render$b], ["__scopeId", "data-v-93207a4f"], ["__file", "D:/projects/学校/外卖app/client/pages/order/order.vue"]]);
  const _sfc_main$b = {
    data() {
      ...
      return {
        ...
        contentHight: windowInfo.screenHeight - 48 - 50 - windowInfo.safeArea.top - (windowInfo.screenHeight - windowInfo.safeArea.bottom),
        contentStyle: {
          height: windowInfo.screenHeight - 48 - 50 - windowInfo.safeArea.top - (windowInfo.screenHeight - windowInfo.safeArea.bottom) + "px"
        },
        currentCategory: 0,
    ...
    computed: {
      categoryActiveIdx() {
        if (this.categorys.length === 0)
          return -1;
        return this.categorys.findIndex((c2) => c2.active);
      }
    },
    onReady() {
    ...
    methods: {
      ...
      async onMenuScroll(ev) {
        const tmp = [];
        for (var i2 = 0; i2 < this.categoryOffsetTops.length; i2++) {
          if (ev.detail.scrollTop >= this.categoryOffsetTops[i2] - this.navHeightAndSafeTop - 3)
            tmp.push(this.categoryOffsetTops[i2]);
          else
            break;
        }
        ...
        if (tmp.length === 0) {
          ...
          activeIdx = this.categoryOffsetTops.findIndex((el2) => el2 === item);
        }
      ...
      vue.createElementVNode(
        ...
        [
          vue.createElementVNode("scroll-view", {
            class: "category-bar",
            "scroll-y": true,
            "scroll-top": $data.categoryScrollTop,
            onScroll: _cache[0] || (_cache[0] = (...args) => $options.onCategoryScroll && $options.onCategoryScroll(...args))
          }, [
            vue.createCommentVNode(' <view class="box" v-for="(_, i) in 20">{{i}}</view> '),
            (vue.openBlock(true), vue.createElementBlock(
              vue.Fragment,
              null,
              vue.renderList($data.categorys, (c2, i2) => {
                return vue.openBlock(), vue.createElementBlock("view", {
                  onClick: ($event) => $options.switchCategory(i2),
                  class: vue.normalizeClass(`category-item ${c2.active ? "active" : ""}`),
                  key: c2.name
                }, [
                  vue.createElementVNode("view", { class: "before" }),
                  vue.createElementVNode(
                    "text",
                    { class: "content" },
          ...
          vue.createElementVNode("view", { class: "menu-bar" }, [
            vue.createElementVNode("scroll-view", {
              "scroll-y": true,
              "scroll-into-view": `_${$data.currentCategory}`,
              onScroll: _cache[1] || (_cache[1] = (...args) => $options.onMenuScroll && $options.onMenuScroll(...args))
            }, [
              vue.createElementVNode("view", { class: "menu-scroll-container" }, [
                (vue.openBlock(true), vue.createElementBlock(
                  vue.Fragment,
                  null,
                  vue.renderList($data.categorys, (c2, i2) => {
                    return vue.openBlock(), vue.createElementBlock("view", { key: i2 }, [
                      ...
                      }, vue.toDisplayString(c2.name), 9, ["id"]),
                      vue.createElementVNode("view", { class: "menu-container" }, [
                        (vue.openBlock(true), vue.createElementBlock(
                          vue.Fragment,
                          null,
                          vue.renderList(c2.menus, (_2, j2) => {
                            return vue.openBlock(), vue.createBlock(_component_menu_item, { key: j2 });
                          }),
                          128
                          /* KEYED_FRAGMENT */
                        ))
                ...
                vue.createCommentVNode(" 到底了 "),
                vue.createElementVNode("view", { class: "bottom-placeholder" }, " 已经到底啦 ")
              ])
            ], 40, ["scroll-into-view"])
          ])
        ],
  ...
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render$a], ["__scopeId", "data-v-1cf27b2a"], ["__file", "D:/projects/学校/外卖app/client/pages/index/index.vue"]]);
  const _sfc_main$a = {
    data() {
      return {};
    },
  ...
  const PagesMyMy = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["render", _sfc_render$9], ["__file", "D:/projects/学校/外卖app/client/pages/my/my.vue"]]);
  const _sfc_main$9 = {
    onLoad(option) {
      formatAppLog("log", "at pages/wv/wv.vue:8", option.url);
      formatAppLog("log", "at pages/wv/wv.vue:9", unescape(option.url));
      this.src = unescape(option.url);
    },
    data() {
      return {
        src: ""
  ...
  function _sfc_render$8(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("web-view", { src: $data.src }, null, 8, ["src"]);
  }
  const PagesWvWv = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$8], ["__file", "D:/projects/学校/外卖app/client/pages/wv/wv.vue"]]);
  __definePage("pages/order-plus/order-plus", PagesOrderPlusOrderPlus);
  __definePage("pages/order/order", PagesOrderOrder);
  __definePage("pages/index/index", PagesIndexIndex);
  __definePage("pages/my/my", PagesMyMy);
  __definePage("pages/wv/wv", PagesWvWv);
  const _sfc_main$8 = {
    name: "UniTag",
    emits: ["click"],
    props: {
  ...
  const __easycom_0 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$7], ["__scopeId", "data-v-1f94d070"], ["__file", "D:/projects/学校/外卖app/client/uni_modules/uni-tag/components/uni-tag/uni-tag.vue"]]);
  const _sfc_main$7 = {
    name: "menu-item",
    data() {
      return {
  ...
  function _sfc_render$6(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "menu" }, [
      ...
      vue.createElementVNode("view", { class: "info" }, [
        vue.createElementVNode("view", { class: "title" }, "【新人福利】员外力荐！皮蛋瘦肉粥"),
        vue.createCommentVNode(" 标签行 "),
        vue.createElementVNode("view", { class: "tags" }, [
          vue.createVNode(_component_uni_tag, {
            text: "标签",
            type: "warning",
            size: "mini",
            "custom-style": $data.tagStyle
          }, null, 8, ["custom-style"]),
          vue.createVNode(_component_uni_tag, {
            text: "这个标签很长",
            type: "warning",
        ...
        vue.createElementVNode("view", { class: "sale-count" }, [
          vue.createElementVNode("text", { class: "count" }, "月售100+"),
          vue.createElementVNode("text", null, "好评度91%")
        ]),
        vue.createCommentVNode(" 商家 标签行 "),
        vue.createElementVNode("view", { class: "tags" }, [
          vue.createVNode(_component_uni_tag, {
            inverted: true,
            text: "标签",
            type: "warning",
            size: "mini",
            "custom-style": $data.merchantTags
          }, null, 8, ["custom-style"]),
          vue.createVNode(_component_uni_tag, {
            inverted: true,
            text: "这个标签很长",
        ...
        vue.createElementVNode("view", { class: "price-row" }, [
          vue.createElementVNode("text", { class: "price" }, [
            vue.createTextVNode("￥"),
            vue.createElementVNode("text", { class: "yuan" }, "8"),
            vue.createTextVNode(".9")
          ]),
          vue.createTextVNode("  "),
          vue.createElementVNode("text", { class: "discard" }, "￥9.9"),
          vue.createElementVNode("view", { class: "plus" }, "+")
        ])
      ])
    ]);
  }
  const MenuItem = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$6], ["__scopeId", "data-v-6a7ca39d"], ["__file", "D:/projects/学校/外卖app/client/components/menu-item.vue"]]);
  const _sfc_main$6 = {
    name: "nav-bar",
    data() {
      return {
        placeholderStyle: {
          height: getApp().globalData.windowInfo.safeArea.top + "px"
        }
      };
    }
  };
  function _sfc_render$5(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "nb-container" }, [
      vue.createElementVNode(
        "view",
        {
          style: vue.normalizeStyle($data.placeholderStyle)
        },
        null,
        4
        /* STYLE */
      ...
      vue.createElementVNode("view", { class: "content" }, [
        vue.createElementVNode("view", null, "菜单"),
  ...
  const Navbar = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$5], ["__scopeId", "data-v-a0412dee"], ["__file", "D:/projects/学校/外卖app/client/components/nav-bar.vue"]]);
  const _sfc_main$5 = {
    name: "nav-bar-plus",
    props: {
      bgColor: {
    ...
    methods: {
      onBackClick() {
        formatAppLog("log", "at components/nav-bar-plus.vue:44", "click");
      }
    }
  };
    ...
    return vue.openBlock(), vue.createElementBlock(
      ...
      [
        ...
        vue.createElementVNode("view", { class: "nav-container" }, [
          ...
          vue.createElementVNode("view", { class: "prefix" }, [
            vue.renderSlot(_ctx.$slots, "prefix", {}, () => [
              typeof $props.back === "function" ? (vue.openBlock(), vue.createElementBlock("view", {
                key: 0,
                onClick: _cache[0] || (_cache[0] = (...args) => $options.onBackClick && $options.onBackClick(...args))
              }, "返回")) : vue.createCommentVNode("v-if", true)
            ], true)
          ]),
          vue.createElementVNode("view", { class: "suffix" }, [
  ...
  const NavbarPlus = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$4], ["__scopeId", "data-v-d0d4b5bc"], ["__file", "D:/projects/学校/外卖app/client/components/nav-bar-plus.vue"]]);
  const _sfc_main$4 = {
    data() {
      return {
        placeholderHeight: getApp().globalData.windowInfo.safeArea.top
  ...
  function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "text-base" }, [
      vue.createElementVNode(
        "view",
        {
          style: vue.normalizeStyle({ height: $data.placeholderHeight + "px" })
      ...
      vue.createElementVNode("view", { class: "relative flex justify-center items-center h-[48px]" }, [
        vue.createElementVNode("view", { class: "absolute left-0 pl-3" }, [
          vue.renderSlot(_ctx.$slots, "prefix", {}, () => [
            vue.createElementVNode("text", null, "<")
          ])
        ]),
        ...
        vue.createElementVNode("view", { class: "absolute right-0 pr-3" }, [
  ...
  const TwNavBar = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$3], ["__file", "D:/projects/学校/外卖app/client/components/tw-nav-bar.vue"]]);
  const _sfc_main$3 = {
    data() {
      return {};
    },
  ...
  const Card = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$2], ["__file", "D:/projects/学校/外卖app/client/components/card/index.vue"]]);
  const _sfc_main$2 = {
    emits: ["tap"],
    data() {
      return {};
  ...
  function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", {
      class: "flex",
      onClick: _cache[0] || (_cache[0] = ($event) => _ctx.$emit("tap"))
    }, [
      vue.createElementVNode("view", { class: "grow" }, [
        vue.renderSlot(_ctx.$slots, "default")
      ]),
      vue.createElementVNode("view", { class: "self-center pl-2" }, ">")
    ]);
  }
  const CardTapable = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$1], ["__file", "D:/projects/学校/外卖app/client/components/card/card-tapable.vue"]]);
  const _sfc_main$1 = {
    data() {
      return {};
    },
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "inline-block px-[4px] py-[2px] bg-blue-100 rounded text-blue-600 font-normal text-xs" }, [
      vue.createElementVNode("text", { class: "relative top-[1px]" }, [
        vue.renderSlot(_ctx.$slots, "default", {}, () => [
  ...
  const Tag = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__file", "D:/projects/学校/外卖app/client/components/tag/index.vue"]]);
  function myPlus() {
    return {
      install(app, params) {
  ...
  const _sfc_main = {
    onLaunch: function() {
      ...
      this.globalData.windowInfo = uni.getWindowInfo();
      if (uni.getSystemInfoSync().platform === "android") {
        const EnvUtils = plus.android.importClass("com.alipay.sdk.app.EnvUtils");
        EnvUtils.setEnv(EnvUtils.EnvEnum.SANDBOX);
        formatAppLog("log", "at App.vue:12", EnvUtils);
        formatAppLog("log", "at App.vue:13", EnvUtils.EnvEnum.SANDBOX);
        formatAppLog("log", "at App.vue:14", EnvUtils.isSandBox());
      }
    },
    onShow: function() {
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "D:/projects/学校/外卖app/client/App.vue"]]);
  ...
  const pages = [
    {
      path: "pages/order-plus/order-plus",
      style: {
  ...
  const tabBar = {
    ...
    list: [
      {
        pagePath: "pages/order-plus/order-plus",
        text: "菜单"
      },
      {
  ...
  const b = true, k = "app", T = S([]), P = k, A = S('{\n    "address": [\n        "127.0.0.1",\n        "192.168.47.1",\n        "192.168.248.1",\n        "192.168.3.137"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "D:/Program Files/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), E = S('[{"provider":"aliyun","spaceName":"wm-app","spaceId":"mp-28b11b03-2f72-4228-8bf9-29195f3e8a55","clientSecret":"oM+keccgyMikjX7l1DODrA==","endpoint":"https://api.next.bspapp.com"}]') || [];
  let x = "";
  try {
    x = "__UNI__AB4775A";
  } catch (e) {
